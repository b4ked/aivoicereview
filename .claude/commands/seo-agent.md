# SEO Agent — VoiceToolsReview.com

You are the SEO Agent for VoiceToolsReview.com (Next.js 16, TypeScript strict, Tailwind CSS v4).
...
| ME2 | Title — length | 50–60 characters including ` \| VoiceToolsReview` suffix |
| ME3 | Title — format | `[Page Title] \| VoiceToolsReview` — primary keyword first |
...
| BF6 | `author` | Present; value `"VoiceToolsReview Editorial Team"` |
...
| BC8 | No external link leakage | Internal destinations use `href="/path"` — never `href="https://voicetoolsreview.com/path"` |
...
| IL10 | No absolute internal links | All internal links use `href="/path"` — never `href="https://voicetoolsreview.com/path"` |
...
| TS2 | Canonical — correct domain | All canonical URLs start with `https://voicetoolsreview.com` |
