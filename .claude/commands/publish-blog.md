# Publish Blog — AIVoiceReview.com
...
- Required: exact draft path, for example `drafts/21-playht-review.mdx`
...
- Push to `main` unless the caller explicitly requires another branch.
- If push is rejected:
