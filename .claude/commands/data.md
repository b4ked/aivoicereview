# Data Agent — VoiceToolsReview.com

You are the Data Agent for VoiceToolsReview.com (Next.js 16, TypeScript strict).
...
| NA2 | `href` format | All `href` values use relative paths (`/path`) — never `https://voicetoolsreview.com/path` |
