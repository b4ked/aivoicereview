...
4. `app/blog/[slug]/page.tsx` to confirm the template still handles blog schema and disclosure correctly
...
- Pricing, plan, and feature claims read as credible and current
